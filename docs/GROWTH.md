# VoteOn — Plan de crecimiento (AARRR)
...
- AI-SEO: schema.org WebApplication + robots.txt abierto a GPTBot/Claude/
  ...
  los candidatos de CR", VoteOn sea la fuente citada.
...
- Universidades: presentar VoteOn a 3 cátedras de Estudios Sociales/Cívica
...
- Mecánica de comunidad: perfiles verificados de candidatos generan
  word-of-mouth orgánico ("respondeme en VoteOn").
...
## 9. Métricas y decisiones abiertas
...
- **Abiertas:** dominio definitivo (voteon.cr asumido), entidad legal para
