...
const FeatureCard = ({ icon, title, desc, accentColor }) => (
  <div className="bg-white p-8 rounded-[2.5rem] flex items-start gap-5 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.04)] border border-slate-50 hover:shadow-2xl hover:-translate-y-2 transition-all cursor-pointer group">
    <div 
