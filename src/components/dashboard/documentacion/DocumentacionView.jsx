...
const DocumentacionView = () => {
 return (
  <div className="w-full font-sans pb-24 animate-in fade-in duration-500 transition-colors">
   ...
   {/* Header (VOTEON) */}
   <div className="bg-accent text-white py-16 px-6 lg:px-24 rounded-b-[3rem] shadow-xl relative overflow-hidden shrink-0 transition-colors">
    <div className="absolute top-0 right-10 w-96 h-96 bg-danger rounded-full opacity-20 blur-3xl -translate-y-1/2 translate-x-1/2"></div>
    <div className="max-w-[1200px] mx-auto relative z-10">
     <div className="flex items-center gap-4 mb-6">
      <Landmark size={48} className="text-danger" />
