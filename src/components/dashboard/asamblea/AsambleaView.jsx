   ...
   <main className="w-full max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-24 space-y-24">
    ...
    <section id="historia" className="grid xl:grid-cols-2 gap-16 items-start w-full">
      <div className="space-y-8 w-full">
       ...
       <div className="bg-surface p-10 rounded-3xl border border-line shadow-sm space-y-4 w-full transition-colors">
        ...
        <div className="p-10 lg:p-12 space-y-8 flex-grow flex flex-col justify-center">
         {[
          ...
          <div key={i} className="flex gap-6 items-start">
           <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/50 rounded-full flex items-center justify-center text-blue-600 shrink-0 mt-1 transition-colors">
            <CheckCircle size={18} />
           </div>
           <div>
    ...
    <section id="hemiciclo" className="space-y-12 text-center bg-surface rounded-[4rem] p-8 lg:p-16 shadow-sm border border-line overflow-hidden w-full relative transition-colors">
      ...
      <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto pt-10 border-t border-line relative z-10 transition-colors">
       {[
    ...
    <section id="proyectos" className="space-y-12 w-full">
     ...
     <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      {(activeTab === 'proyectos' ? [
       ...
       <div key={idx} className="bg-surface p-10 rounded-3xl border border-line shadow-sm hover:shadow-xl transition-all group w-full">
    ...
    <section id="calendario" className="grid xl:grid-cols-2 gap-16 items-start w-full">
      ...
      <div className="space-y-10 w-full">
       <div className="bg-surface p-10 lg:p-12 rounded-3xl border border-line shadow-sm w-full transition-colors">
           ...
           <div key={index} className="border border-line rounded-2xl overflow-hidden transition-all">
            ...
            {openFaq === index && (
             <div className="p-5 bg-surface border-t border-line animate-in fade-in slide-in-from-top-2 transition-colors">
              <p className="text-muted text-sm md:text-base leading-relaxed font-medium transition-colors">{faq.a}</p>
             </div>
            )}
           </div>
          ))}
    ...
    <section className="w-full flex justify-center pb-12">
      <a 
       ...
       className="group flex flex-col md:flex-row items-center gap-6 bg-gradient-to-br from-[#001D4A] to-blue-900 dark:from-slate-800 dark:to-slate-900 px-10 py-8 rounded-3xl shadow-2xl hover:shadow-blue-900/30 hover:-translate-y-1 transition-all w-full max-w-4xl"
      >
